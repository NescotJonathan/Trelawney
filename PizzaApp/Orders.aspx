...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:aramarkdatabaseConnectionString1 %>" DeleteCommand="DELETE FROM [Pizzaorders] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Pizzaorders] ([Customername], [Pizza], [Size], [Crust], [Price]) VALUES (@Customername, @Pizza, @Size, @Crust, @Price)" SelectCommand="SELECT * FROM [Pizzaorders]" UpdateCommand="UPDATE [Pizzaorders] SET [Customername] = @Customername, [Pizza] = @Pizza, [Size] = @Size, [Crust] = @Crust, [Price] = @Price WHERE [Id] = @Id">
            <DeleteParameters>
